                            ...
                            <div class="card card-info card-outline">
                                ...
                                <div class="card-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                        @foreach(MyBidsAsBuyer() as $key => $product_bid)
                                            <tr>
                                                ...
                                                <td>{{$product_bid->bid_quantity ? getNumberToBangla($product_bid->bid_quantity) :getNumberToBangla($product_bid->product->quantity)}} {{$product_bid->product->unit ? getNameByBnEn($product_bid->product->unit) :''}} </td>
