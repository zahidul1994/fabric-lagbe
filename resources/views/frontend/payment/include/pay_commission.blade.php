<form role="form" action="{{ route('stripe2.post') }}" method="post" class="require-validation"
...
{{--                                      data-stripe-publishable-key="pk_test_c6VvBEbwHFdulFZ62q1IQrar"--}}
    ...
    <div class="row">
        <div class="col-12">
            @php
            //dd(Session::get('payment_history_id'));
                $amount = \App\Model\PaymentHistory::where('id',Session::get('payment_history_id'))->pluck('amount')->first();
            @endphp
