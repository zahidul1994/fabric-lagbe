...
class BkashController extends Controller
{
    ...
    public function pay(Request $request,$id,$monthly=null)
    {
        ...
        //         return view('frontend.seller.premium_membership.buy_now_details',compact('membershipPackage','bkashAmount','monthly_amount'));
        //     }else{
        //         return view('frontend.buyer.premium_membership.buy_now_details',compact('membershipPackage','bkashAmount','monthly_amount'));
        //     }
        ...
        Session::put('bkash_token', $token);
        if (Auth::user()->user_type == 'seller'){
            return view('frontend.seller.premium_membership.buy_now_details',compact('membershipPackage','bkashAmount','monthly'));
        }else{
            return view('frontend.buyer.premium_membership.buy_now_details',compact('membershipPackage','bkashAmount','monthly'));
        }
