...
@section("title","Sizing Product Edit")
@push('css')
    ...
    <div class="full-row" style="margin-top: -30px;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    <form class="woocommerce-form-login" action="{{route('seller.sizing-product.update',$product->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="row">
                                    <div class="col-lg-5 col-md-5 col-5">
                                        <h3 class="card-title float-left">
                                          @lang('website.Sizing Product Edit')
                                        </h3>
                                    </div>
