...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Add Sub Sub Child Category</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                        <li class="breadcrumb-item active">Add Sub Sub Child Category</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="row">
            ...
            <!-- general form elements -->
                ...
                <div class="card-header">
                    <h3 class="card-title float-left">Add Sub Sub Child Category</h3>
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" action="{{route( Request::segment(2) == 'sub-sub-child-categories'? 'admin.sub-sub-child-categories.store':'admin.wo-sub-sub-child-categories.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                        ...
                        <div class="form-group">
                            <label for="sub_sub_category_id">Sub Sub Child Category Name</label>
