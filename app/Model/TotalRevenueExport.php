...
class TotalRevenueExport implements FromCollection, WithMapping, WithHeadings
{
    ...
    public function map($totalSales): array
    {
        ...
        if($sale_type == 'mp'){
           $amount =  $totalSales->amount_after_getaway_fee;
        }else{
            $amount =  $totalSales->commission;
        }
