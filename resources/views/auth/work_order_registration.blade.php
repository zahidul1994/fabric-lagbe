                                        ...
                                        <div class="sign-in-form">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-6">
                                                    <!-- small box -->
                                                    <a href="{{route('work-order.registration.buyer')}}">
                                                        <div class="card border-primary mb-3" style="max-width: 18rem; margin: 10px; background-color: #f3f3f3">
                                                            <div class="card-body text-primary card_height">
                                                                ...
                                                                <div class="text-center">
                                                                    <h5 style="color: #e70909;">@lang('website.Work Order Provider')</h5> <hr style="color: #e70909;">
                                                                    <h5 style="color: #e70909;"></h5>
                                                ...
                                                <div class="col-lg-6 col-6">
                                                    <!-- small box -->
                                                    <a href="{{route('work-order.registration.seller')}}">
                                                        <div class="card border-secondary mb-3" style="max-width: 18rem; margin: 10px; background-color: #f3f3f3;">
                                                            <div class="card-body text-secondary card_height">
                                                                ...
                                                                <div class="text-center">
                                                                    <h5 style="color: purple;">@lang('website.Work Order Receiver')</h5> <hr style="color: purple;">
                                                                    <h5 style="color: purple;"></h5>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </a>
