                                ...
                                <div class="col-12">
                                    <div class="products-header d-flex justify-content-between align-items-center py-10 px-20 bg-light md-mt-30">
                                        <div class="products-header-left d-flex align-items-center">
                                            <h4 class="woocommerce-products-header__title page-title">@lang('website.All') @lang('website.Featured Products')</h4>
                                            <div class="woocommerce-result-count">({{getNumberToBangla($products->count())}})</div>
                                        </div>
                                    </div>
                                    @if($products->count() > 0)
                                    <div class="showing-products pt-30 pb-50 border-2 border-bottom border-light">
                                        <div class="row row-cols-xl-3 row-cols-md-3 row-cols-sm-3 row-cols-2 e-hover-image-zoom e-image-bg-light e-btn-set-two cart-slide-up g-4">
