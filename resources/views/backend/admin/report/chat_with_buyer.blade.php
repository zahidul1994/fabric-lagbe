...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Chat With Buyer <span style="font-size: 16px">({{$saleRecord->product->name}}) <img src="{{url($saleRecord->product->thumbnail_img)}}" width="50" height="50"></span></h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card card-primary">
                        <div class="card-header image">
                            <h3 class="card-title">
                                ...
                                <img class="incoming_msg_img img-circle elevation-2 border-box img-rounded" src=" {{!empty($buyerDetails->avatar_original) ? asset($buyerDetails->avatar_original) : "https://ptetutorials.com/images/user-profile.png"}} " alt="Buyer Image">
...
@push('js')
    ...
    <script>
        ...
        var chat_id = `buyerId_${buyerId}_orderId_${orderId}_adminId_${admin_id}`
        // Initialize Firebase
