                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Seller Product List</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('admin.seller-product-list')}}" method="get">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{route('admin.seller-product-list')}}" type="reset" class="btn btn-secondary">Cancel</a>
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->
                ...
                <div class="card card-info card-outline">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a href="{{route('admin.feature_products_priority','seller')}}" class="btn btn-success text-white">Set featured products priority</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
    ...
    <script>
        $(function() {
            $('#customised_data_table').DataTable({
                ...
                ajax: '{{ route('admin.seller-product-list.ajax',['start_date'=>$start_date,'end_date'=>$end_date]) }}',
                columns: [
                    {
                        "title": "#SL",
