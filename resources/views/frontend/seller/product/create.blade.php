...
@section('content')
    ...
    @php
        ...
        $memPackId = auth()->user()->membership_package_id;
    ...
    <div class="full-row" style="margin-top: -30px;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    <form class="woocommerce-form-login" action="{{ route('seller.products.store') }}" method="POST"
                                ...
                                <div class="row m-2">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div
                                                ...
                                                <label for="name"> @lang('website.Product Type English') <span
                                    ...
                                    <div class="col-md-12" style="padding-top: 20px;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="number" class="form-control"
                                                                name="var_quantity[]" placeholder="Quantity"></td>
                                                    </tr>
                                                    <tr>
                                                        <td><input type="number" class="form-control" name="var_price[]"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="unit_price">Comission<span
                                                            class="required">*</span></label>
                                                    <input readonly type="number" value="" step="0.00001"
                                                        placeholder="0" name="comission" id="comission"
                                                        class="form-control" style="border: 1px solid #dddddd">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="totalComission">Total Comission <span
                                                            class="required">*</span></label>
                                                    <input readonly type="number" value="" step="0.00001"
                                                        placeholder="0" name="totalComission" id="totalComission"
                                                        class="form-control" style="border: 1px solid #dddddd">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="vatOnComission">VAT/LAC <span
                                                            class="required">*</span></label>
                                                    <input readonly type="number" value="" step="0.00001"
                                                        placeholder="0" name="vatOnComission" id="vatOnComission"
                                                        class="form-control" style="border: 1px solid #dddddd">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="return_amount">Total Return Amount<span
                                                            class="required">*</span></label>
                                                    <input readonly type="number" value="" step="0.00001"
                                                        name="return_amount" class="form-control" id="return_amount"
                                                        style="background-color: #f3f3f3" required readonly>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="comissionUsd">Comission<span
                                                            class="required">*</span></label>
                                                    <input readonly type="number" value="" step="0.00001"
                                                        placeholder="0" name="comissionUsd" id="comissionUsd"
                                                        class="form-control" style="border: 1px solid #dddddd">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="totalComissionUsd">Total Comission <span
                                                            class="required">*</span></label>
                                                    <input readonly type="number" value="" step="0.00001"
                                                        placeholder="0" name="totalComissionUsd" id="totalComissionUsd"
                                                        class="form-control" style="border: 1px solid #dddddd">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="vatOnComissionUsd">VAT/LAC <span
                                                            class="required">*</span></label>
                                                    <input readonly type="number" value="" step="0.00001"
                                                        placeholder="0" name="vatOnComissionUsd" id="vatOnComissionUsd"
                                                        class="form-control" style="border: 1px solid #dddddd">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="return_amountUsd">Total Return Amount<span
                                                            class="required">*</span></label>
                                                    <input readonly type="number" value="" step="0.00001"
                                                        name="return_amountUsd" class="form-control"
                                                        id="return_amountUsd" style="background-color: #f3f3f3" required
                                                        readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select name="delivery_charge" id="delivery_charge"
                                                    class="form-control demo-select2" required>
                                                    <option selected disabled> Select</option>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select name="partial_payment" id="partial_payment"
                                                    class="form-control demo-select2" required>
                                                    <option selected disabled> Select</option>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select name="sample_provider" id="sample_provider"
                                                    class="form-control demo-select2" required>
                                                    <option selected disabled> Select</option>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select name="sample_charge" id="sample_charge"
                                                    class="form-control demo-select2" required>
                                                    <option selected disabled> Select</option>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select name="partial_delivery" id="partial_delivery"
                                                    class="form-control demo-select2" required>
                                                    <option selected disabled> Select</option>
                                                    <option value="Allowed">Allowed</option>
                                                    <option value="Not Allowed">Not Allowed</option>
...
@push('js')
    ...
    <script>
        ...
        function get_bid_price(el) {
            ...
            var membershipPackageId = "<?php echo "$memPackId"; ?>";
            console.log(membershipPackageId)
            ...
            var expected_price = (parseFloat(qty) * parseFloat(unit_price));
            var totalVat = ((unit_price * qty) * defaultvatperent) / 100;
            $('#vat').val(totalVat);

            if (membershipPackageId == 3) {
                var comission = (expected_price * (1.5 / 100))
                var vatOnComission = (comission * (5 / 100))
                var totalComission = comission + vatOnComission
                var returnAmount = expected_price - totalComission;

                var comissionUsd = ((expected_price * (1.5 / 100))) / 100
                var vatOnComissionUsd = ((comission * (5 / 100))) / 100
                var totalComissionUsd = (comission + vatOnComission) / 100
                var returnAmountUsd = (expected_price - totalComission) / 100
            } else if (membershipPackageId == 2) {
                var comission = (expected_price * (2 / 100))
                var vatOnComission = (comission * (5 / 100))
                var totalComission = comission + vatOnComission
                var returnAmount = expected_price - totalComission;
                var comissionUsd = ((expected_price * (2 / 100))) / 100
                var vatOnComissionUsd = ((comission * (5 / 100))) / 100
                var totalComissionUsd = (comission + vatOnComission) / 100
                var returnAmountUsd = (expected_price - totalComission) / 100
            } else if (membershipPackageId == 1) {
                var comission = (expected_price * (2.5 / 100))
                var vatOnComission = (comission * (5 / 100))
                var totalComission = comission + vatOnComission
                var returnAmount = expected_price - totalComission;
                var comissionUsd = ((expected_price * (2.5 / 100))) / 100
                var vatOnComissionUsd = ((comission * (5 / 100))) / 100
                var totalComissionUsd = (comission + vatOnComission) / 100
                var returnAmountUsd = (expected_price - totalComission) / 100
            }
            ...
            if (qty > 0 && bid_price > 0) {
                ...
                $.post('{{ route('bid.price.convert') }}', {
                    ...
                    function(data) {
                        // location.reload();
                        console.log(data, comission, expected_price);
                        $('#bid_convert_unit_price').val(data.bid_convert_unit_price);
                        $('#bid_convert_total_price').val(data.bid_convert_total_price);
                        $('#converted_vat').val(data.converted_vat);
                        $('#return_amount').val(returnAmount);
                        $('#comission').val(comission);
                        $('#vatOnComission').val(vatOnComission);
                        $('#totalComission').val(totalComission);


                        $('#return_amountUsd').val(returnAmountUsd);
                        $('#comissionUsd').val(comissionUsd);
                        $('#vatOnComissionUsd').val(vatOnComissionUsd);
                        $('#totalComissionUsd').val(totalComissionUsd);
