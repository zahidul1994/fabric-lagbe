    ...
    <section class="content">
        <div class="row">
            ...
            <!-- general form elements -->
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" action="{{route( Request::segment(2) == 'sub-sub-categories'? 'admin.sub-sub-categories.store':'admin.work-order-sub-sub-categories.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                        ...
                        <div class="form-group">
                            <label for="sub_category_id">SubCategory Name (@lang('website.Optional'))</label>
