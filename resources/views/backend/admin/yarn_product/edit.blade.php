...
@section("title","Edit Yarn Products")
@push('css')
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Edit Yarn Products</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                        <li class="breadcrumb-item active">Edit Yarn Products</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <!-- Main content -->
    <form action="{{route('admin.yarn-product.update',$product->id)}}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
