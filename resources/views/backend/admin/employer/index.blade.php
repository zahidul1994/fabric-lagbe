            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('admin.employer.index')}}" method="get">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{route('admin.employer.index')}}" type="reset" class="btn btn-secondary">Cancel</a>
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->
    ...
    <script>
        $(function() {
            $('#customised_data_table').DataTable({
                ...
                ajax: '{{ route('admin.employer-list.ajax',['start_date'=>$start_date,'end_date'=>$end_date]) }}',
                columns: [
                    {
                        "title": "#SL",
