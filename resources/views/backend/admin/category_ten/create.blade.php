...
@section("title","Add Category Ten")
@push('css')
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Add Category Ten</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                        <li class="breadcrumb-item active">Add Category Ten</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-8 offset-2">
                ...
                <div class="card card-info card-outline">
                    <div class="card-header">
                        <h3 class="card-title float-left">Add Category Ten</h3>
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{route( Request::segment(2) == 'category-ten'? 'admin.category-ten.store':'admin.wo-category-ten.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="category_nine_id" id="category_nine_id" class="form-control select2">
                                    @foreach($categoryNines as $categoryNine)
                                        <option value="{{$categoryNine->id}}">{{$categoryNine->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
