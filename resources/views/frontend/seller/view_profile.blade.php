                ...
                <div class="col-lg-9">
                            ...
                            <div class="card col-lg-6 col-md-6 col-12">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{getNumberToBangla(Auth::User()->phone)}}</td>
                                    </tr>
                                    <tr>
                                        <td>@lang('website.Company Name'):</td>
                                        <td>{{getCompanyNameByBnEn($seller)}}</td>
                                    </tr>
                                    <tr>
                                        <td>@lang('website.Company Address'):</td>
                                        <td>{{getCompanyAddressByBnEn($seller)}}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="row" style="padding-top: 40px;">
                        <div class="col-lg-4 col-md-4 col-5">
                            <a class="btn btn-primary" href="{{route('seller.edit-profile')}}">@lang('website.Edit Profile') </a>
                        </div>
