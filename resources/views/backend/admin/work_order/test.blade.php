...
@section('content')
    ...
    <!-- Main content -->
    <form  action="{{route('admin.seller-work-order.update',$workOrderProduct->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
                ...
                <div class="row">
                    <div class="col-6">
                        <h4 class="card-title float-left">
                            Create Factory Production Capacity
                        </h4>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <div class="row m-2">
                    ...
                    <div class="col-md-10" style="padding-top: 20px;">
                        ...
                        <div class="form-group">
                            <label for="description">Product/Service Details <span class="required">*</span></label>
                    ...
                    <div class="col-md-10" style="padding-top: 20px;">
                        <div class="form-group row">
                            <label class="control-label ml-3 col-12">Attach Previous Work Images <span class="required">*</span> <small class="text-danger">(Size: 290 * 300px)</small></label>
