...
@section("title","Buyer Work Order List")
@push('css')
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Buyer Work Order List</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                        <li class="breadcrumb-item active">Buyer Work Order List</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card card-info card-outline">
                    <div class="card-header">
                        <h3 class="card-title float-left">Buyer Work Order Lists</h3>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach($workOrderProducts as $key => $workOrderProduct)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="bg-info dropdown-item" href="{{route('admin.seller-product.edit',$workOrderProduct->id)}}">
