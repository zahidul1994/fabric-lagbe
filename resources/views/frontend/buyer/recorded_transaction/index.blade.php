                                ...
                                <div class="card-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th>@lang('website.Seller') @lang('website.Name')</th>
                                            <th>@lang('website.Buyer') @lang('website.Name')</th>
                                            <th>@lang('website.Product Image')</th>
                                            <th>@lang('website.Product Name')</th>
                                            <th>@lang('website.Product Unit Price')</th>
                                        ...
                                        @foreach($saleRecords as $key => $saleRecord)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary" href="{{route('buyer.recorded-transaction.print',encrypt($saleRecord->id))}}"><i class="fa fa-print"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
