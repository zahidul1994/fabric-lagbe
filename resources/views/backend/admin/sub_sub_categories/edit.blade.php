        ...
        <div class="row">
            <div class="col-8 offset-2">
                ...
                <div class="card card-info card-outline">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{route('admin.sub-sub-categories.update',$subsubcategory->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="name_bn" id="name_bn" value="{{$subsubcategory->name_bn}}" required>
                                </div>
                            </div>
