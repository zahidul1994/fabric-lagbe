            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Create About Us Content</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-8 offset-2">
                ...
                <div class="card card-info card-outline">
                    <div class="card-header">
                        <h3 class="card-title float-left">Create About Us Content</h3>
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{route('admin.about-us.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
