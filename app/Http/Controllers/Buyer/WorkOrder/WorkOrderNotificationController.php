...
class WorkOrderNotificationController extends Controller
{
    public function index(){
        $notifications = Notification::where('receiver_user_id',Auth::id())
            ...
            ->latest()
            ->get();
        return view('frontend.buyer.work_order.wo_notifications',compact('notifications'));
    ...
    public function details($id){
        ...
        $notification->save();
        return view('frontend.buyer.work_order.wo_notification_details',compact('notification'));
    }
}
